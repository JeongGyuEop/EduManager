...
public class MenuItemService {
	...
	private void initializeRoleMenuMap() {
        ...
        roleMenuMap.put("관리자", Arrays.asList(
            new MenuItemVo("사용자 관리", "/studentUser/studentRegister.bo?center=/view_admin/studentManage.jsp", Arrays.asList(
                new MenuItemVo("학생관리", "/studentUser/studentRegister.bo?center=/view_admin/studentManage.jsp"),
