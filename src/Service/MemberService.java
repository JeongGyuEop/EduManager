...
//===================================================================================	
 ...
 // 학생 등록 메서드
    public int registerStudent(HttpServletRequest request) {
        ...
        // VO 객체 생성 및 설정
        MemberVo student = new MemberVo(user_id, user_pw, user_name, birthDate, gender, address, phone, email, role, student_id, majorcode, grade, admission_date, status);
  ...
  //===================================================================================
    ...
    public boolean updateStudent(HttpServletRequest request) {
        ...
        // VO 객체에 값 설정
        MemberVo student = new MemberVo(userId, userPw, userName, birthDate, gender, address, phone, email, role, studentId, majorcode, grade, admissionDate, status);
