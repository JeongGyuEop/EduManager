...
public class BoardDAO {
	...
	public List<BoardVo> getEvents(String year, String month) {
	...
	public int deleteSchedules(String[] scheduleIds) {
		int deleteCount = 0;
		...
		try {
			...
			System.out.println("BoardDAO의 deleteSchedules 메소드에서 오류");
			e.printStackTrace();
		} finally {
			closeResource();
		}
