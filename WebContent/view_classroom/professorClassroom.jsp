...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">수강 등록</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">수강 조회(수정/삭제)</a>
                                </nav>
                            </div>
			...
			<% if(role.equals("학생")) { %> 
				<c:set var="classroom_center" value="studentMyCourse.jsp"/>
			<% } else if(role.equals("교수")) { %>	
				<c:set var="classroom_center" value="professorMyCourse.jsp"/>
			<% } %>
			
			
            <!-- 중앙 콘텐츠 영역 -->
            <div id="layoutSidenav_content">
                <jsp:include page="${classroom_center}"/>  
            </div>
        </div>
