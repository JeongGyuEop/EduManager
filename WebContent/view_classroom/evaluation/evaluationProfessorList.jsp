...
<link
	...
	rel="stylesheet">
<link href="<%=request.getContextPath()%>/css/classroom_styles.css"
	rel="stylesheet" />
</head>
<body>
	<div class="container mt-5">
		...
		<form method="get"
			action="<%=request.getContextPath()%>/professor/evaluationList.bo">
			<div class="row mb-3">
				<div class="col-md-8">
				...
				<div class="col-md-4">
					<button type="submit" class="btn"
						style="background-color: #D5E6DE; color: #333; width: 100%; border: none; border-radius: 5px; text-align: center;">검색</button>
				</div>
...
function option() {
	$.ajax({
		...
		/professor/evaluationSearch.bo", // 요청 URL
