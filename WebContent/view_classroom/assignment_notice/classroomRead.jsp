		...
		// 관리자인지 확인하여 수정,삭제 버튼 제목,내용 입력창 활성화 , 비활성화 
	     ...
	     $(document).ready(function () {
	         ...
	         $("#list").on("click", function () {
	             ...
	             url = "<%=contextPath%>/classroomboard/noticeList.bo?center=/view_classroom/assignment_notice/professorNotice.jsp&nowBlock=<%=nowBlock%>&nowPage=<%=nowPage%>&courseId=<%=course_id%>";
