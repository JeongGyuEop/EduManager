...
<body>
    <div id="schedule-container">
        ...
        <!-- 일정 추가 폼 -->
        <form id="scheduleForm" action="<%=contextPath%>/Board/addSchedule" method="post">
            ...
            <input type="submit" value="추가" class="btn" style="background-color: #4a90e2; color: white;">
        </form>

        <h3 class="text-center mt-5">일정 목록</h3>
        <!-- 조회할 달 선택 폼 -->
        <form action="<%=contextPath%>/Board/viewSchedule.bo?" method="get" class="form-inline justify-content-center mt-3">
            <label for="month" class="mr-2">조회할 달:</label>
            <input type="month" id="month" name="month" class="form-control mr-2" required value="<%=request.getParameter("month") != null ? request.getParameter("month") : ""%>">
            <input type="submit" value="조회" class="btn" style="background-color: #4a90e2; color: white;">
        </form>

        <form action="<%out.print(contextPath);%>/Board/deleteSchedule" method="post" class="mt-4">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <c:forEach var="schedule" items="${scheduleList}">
                        <tr>
                            <td><input type="checkbox" name="deleteIds" value="${schedule.schedule_id}"></td>
            ...
            <input type="button" value="선택된 일정 삭제" onclick="deleteSchedules();" class="btn btn-danger">
        </form>
    </div>
