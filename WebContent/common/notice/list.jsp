...
<table width="97%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr align="center"> 
		...
		%>			
				    ...
				    <a href="<%=contextPath%>/Board/list.bo?center=/common/notice/list.jsp&nowBlock=<%=nowBlock-1%>&nowPage=<%=((nowBlock-1)*pagePerBlock)%>">
					◀ 이전 <%=pagePerBlock %>개
					</a>
		<%	
				}
		...
		%>			
				...
				<a href="<%=contextPath%>/Board/list.bo?center=/common/notice/list.jsp&nowBlock=<%=nowBlock%>&nowPage=<%=(nowBlock * pagePerBlock)+i%>">
